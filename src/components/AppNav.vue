...
export default {
  ...
  mounted() {
    ...
    $(document).on('click', function (event) {
      ...
      if (!target.closest('#navbarSupportedContent').length && !target.is('#navbarToggle')) {
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex justify-content-between right-side ms-auto">
                ...
                <div class="navbar-nav ms-auto w-100">
                    ...
                    <span id="space"></span>
                    <!-- Login Button -->
                    <button class="btn btn-sm ms-auto my_button" type="button"><i class="fa-solid fa-house-user"></i> Login</button>
                </div>
            </div>
        </div>
    </div>
